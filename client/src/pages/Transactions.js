      ...
      <div className="row">
        <div className="col">
          <div className="card">
            <div className="card-body text-dark">
              ...
              <p className="price spending">{todaySpending}</p>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card">
            <div className="card-body text-dark">
              <h4>
                Expenditure for Current Week <br></br>({startDate} - {endDate}):
              </h4>
              <p className="price spending">{currentWeekSpending}</p>
            </div>
          </div>
        </div>
        ...
        <div className="col">
          <div className="card">
            <div className="card-body text-dark">
              ...
              <p className="price spending">{currentMonthSpending}</p>
            </div>
          </div>
        </div>
      </div>
